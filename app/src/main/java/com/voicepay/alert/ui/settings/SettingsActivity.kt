...
class SettingsActivity : AppCompatActivity() {
    ...
    private val app by lazy {
        application as VoicePayApplication
    }
    ...
    private fun setupLanguageSpinner() {
        ...
        val languages = AnnouncementLanguage.entries.map {
            it.displayName
        }
    ...
    private fun setupListeners() {
        ...
        binding.spinnerLanguage.setOnItemClickListener { _, _, position, _ ->
            viewModel.setLanguage(
                AnnouncementLanguage.entries[position]
            )
        }
    }
    ...
    private fun observeSettings() {
        ...
        viewModel.settings.observe(this) { settings ->
            ...
            binding.switchVoiceEnabled.isChecked =
                settings.voiceEnabled

            binding.switchSpeakSender.isChecked =
                settings.speakSenderName
            ...
            binding.switchKeepAlive.isChecked =
                settings.keepAliveService

            binding.sliderVolume.value =
                settings.volume

            val langIndex =
                AnnouncementLanguage.entries.indexOf(
                    settings.language
                )

            if (
                langIndex >= 0 &&
                binding.spinnerLanguage.text.toString()
                    != settings.language.displayName
            ) {

                binding.spinnerLanguage.setText(
                    settings.language.displayName,
                    false
                )
            }
            ...
            if (appToggleAdapter == null) {
                ...
                appToggleAdapter =
                    AppToggleAdapter(toggles) { pkg, enabled ->

                        viewModel.setAppEnabled(pkg, enabled)
                    }

                binding.recyclerAppToggles.layoutManager =
                    LinearLayoutManager(this)

                binding.recyclerAppToggles.adapter =
                    appToggleAdapter
    ...
    private fun showTemplateDialog() {
        ...
        val withSenderInput = android.widget.EditText(this).apply {
            ...
            hint =
                SettingsRepository
                    .DEFAULT_TEMPLATE_WITH_SENDER
        }

        val withoutSenderInput =
            android.widget.EditText(this).apply {
                ...
                hint =
                    SettingsRepository
                        .DEFAULT_TEMPLATE_WITHOUT_SENDER
            }
        ...
        val layout = android.widget.LinearLayout(this).apply {
            ...
            addView(
                android.widget.TextView(
                    ...
                    text = getString(
                        R.string.template_with_sender_label
                    )
                }
            )
            ...
            addView(
                android.widget.TextView(
                    ...
                    text = getString(
                        R.string.template_without_sender_label
                    )
                }
            )
        ...
        MaterialAlertDialogBuilder(this)
            ...
            .setPositiveButton(R.string.save) { _, _ ->
                ...
                viewModel.setTemplates(
                    ...
                    withSenderInput.text.toString()
                        .ifBlank {
                            SettingsRepository
                                .DEFAULT_TEMPLATE_WITH_SENDER
                        },

                    withoutSenderInput.text.toString()
                        .ifBlank {
                            SettingsRepository
                                .DEFAULT_TEMPLATE_WITHOUT_SENDER
                        }
